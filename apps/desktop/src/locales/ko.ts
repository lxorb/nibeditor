...
export const ko: Dictionary = {
  ...
  'That could not be archived.': '아카이브할 수 없었습니다.',
  ...
  Archived: '아카이브됨',
  Unarchived: '아카이브 해제됨',
  'Archive note': '노트 아카이브',
  'Unarchive note': '노트 아카이브 해제',
  'Show them': '보기',
  'archived {when}': '{when} 아카이브',
  '{count} archived notes inside': '안에 아카이브된 노트 {count}개',
