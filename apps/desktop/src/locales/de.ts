...
export const de: Dictionary = {
  ...
  'That could not be archived.': 'Das liess sich nicht archivieren.',
  ...
  'Unarchive note': 'Notiz aus dem Archiv holen',
  'Show them': 'Anzeigen',
  'archived {when}': 'archiviert {when}',
  '{count} archived notes inside': {
    one: '{count} archivierte Notiz darin',
    other: '{count} archivierte Notizen darin',
  },
