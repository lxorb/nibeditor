...
export const fr: Dictionary = {
  ...
  'Pull to add a page': 'Tirez pour ajouter une page',
  'Release to add a page': 'Relâchez pour ajouter une page',
  ...
  'Set cover': 'Choisir une couverture',
  'Change cover': 'Changer la couverture',
  'Remove cover': 'Retirer la couverture',
  'That cover could not be written.': 'Cette couverture n’a pas pu être enregistrée.',
  'Drag to reposition': 'Faire glisser pour repositionner',
  ...
  'Order of the files': 'Ordre des fichiers',
  'Name, A to Z': 'Nom, de A à Z',
  'Name, Z to A': 'Nom, de Z à A',
  'Modified, newest first': 'Modification, la plus récente en premier',
  'Modified, oldest first': 'Modification, la plus ancienne en premier',
  'Created, newest first': 'Création, la plus récente en premier',
  'Created, oldest first': 'Création, la plus ancienne en premier',
  Manual: 'Manuel',
  ...
  'Go to the mark': 'Aller à l’appel de note',
  ...
  'Properties draws the rows and edits them in place; Source is the YAML as typed.':
    'Propriétés affiche les lignes et les modifie sur place ; Source est le YAML tel qu’il a été saisi.',
  Source: 'Source',
  Hidden: 'Masqué',
  Picture: 'Image',
  Comment: 'Commentaire',
  ...
  'Add an AI provider or sign in to turn speech into words.':
    'Ajoute un fournisseur d’IA ou connecte-toi pour transcrire la parole.',
