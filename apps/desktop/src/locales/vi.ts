...
export const vi: Dictionary = {
  ...
  'That could not be archived.': 'Không thể lưu trữ.',
  ...
  'Archive note': 'Lưu trữ ghi chú',
  'Unarchive note': 'Bỏ lưu trữ ghi chú',
  'Show them': 'Xem chúng',
  'archived {when}': 'đã lưu trữ {when}',
  '{count} archived notes inside': '{count} ghi chú lưu trữ bên trong',
