...
export const ps: Dictionary = {
  ...
  'Set cover': 'پوښ وټاکه',
  'Change cover': 'پوښ بدل کړه',
  'Remove cover': 'پوښ لرې کړه',
  'That cover could not be written.': 'دا پوښ ونه ساتل شو.',
  'Drag to reposition': 'د ځای بدلولو لپاره یې کش کړه',
  ...
  'That could not be archived.': 'ارشیف نه شو.',
  ...
  // Archive
  Archive: 'ارشيف کول',
  Unarchive: 'له ارشيف راوستل',
  Archived: 'ارشيف شوي',
  Unarchived: 'له ارشيف راوړل شو',
  'Archive note': 'يادښت ارشيف کول',
  'Unarchive note': 'يادښت له ارشيف راوستل',
  'Show them': 'ښودل',
  'archived {when}': '{when} ارشيف شو',
  '{count} archived notes inside': {
    one: 'دننه {count} ارشيف شوی يادښت',
    other: 'دننه {count} ارشيف شوي يادښتونه',
  },
  ...
  'Properties draws the rows and edits them in place; Source is the YAML as typed.':
    'ځانګړنې کرښې ښيي او هماغه ځای کې يې سموي؛ سرچینه هغه YAML دی لکه چې ليکل شوی.',
  Source: 'سرچینه',
  Hidden: 'پټ',
  Picture: 'انځور',
  Comment: 'څرګندونه',
