...
export const zhHans: Dictionary = {
  ...
  'Change cover': '更换封面',
  'Remove cover': '移除封面',
  'That cover could not be written.': '无法保存该封面。',
  ...
  'That could not be archived.': '无法归档。',
  ...
  Unarchived: '已取消归档',
  'Archive note': '将笔记归档',
  'Unarchive note': '将笔记移出归档',
  'Show them': '显示',
  'archived {when}': '{when}归档',
  '{count} archived notes inside': '里面有{count}篇已归档的笔记',
