...
export const ml: Dictionary = {
  ...
  'That could not be archived.': 'ആർക്കൈവ് ചെയ്യാനായില്ല.',
  ...
  'Archive note': 'കുറിപ്പ് ആർക്കൈവ് ചെയ്യുക',
  'Unarchive note': 'കുറിപ്പ് ആർക്കൈവിൽ നിന്ന് മാറ്റുക',
  'Show them': 'കാണിക്കുക',
  'archived {when}': '{when} ആർക്കൈവ് ചെയ്തു',
  '{count} archived notes inside': {
    one: 'ഉള്ളിൽ {count} ആർക്കൈവ് കുറിപ്പ്',
    other: 'ഉള്ളിൽ {count} ആർക്കൈവ് കുറിപ്പുകൾ',
  },
