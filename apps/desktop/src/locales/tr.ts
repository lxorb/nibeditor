...
export const tr: Dictionary = {
  ...
  'That could not be archived.': 'Arşivlenemedi.',
  ...
  'Archive note': 'Notu arşivle',
  'Unarchive note': 'Notu arşivden çıkar',
  'Show them': 'Göster',
  'archived {when}': '{when} arşivlendi',
  '{count} archived notes inside': {
    one: 'İçinde {count} arşivlenmiş not',
    other: 'İçinde {count} arşivlenmiş not',
  },
