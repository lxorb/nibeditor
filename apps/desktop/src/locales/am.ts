...
export const am: Dictionary = {
  ...
  'That could not be archived.': 'ማኅደር ማድረግ አልተቻለም።',
  ...
  'Archive note': 'ማስታወሻውን ማህደር አስገባ',
  'Unarchive note': 'ማስታወሻውን ከማህደር አውጣ',
  'Show them': 'አሳያቸው',
  'archived {when}': '{when} ማህደር ገብቷል',
  '{count} archived notes inside': {
    one: 'ውስጡ በማህደር {count} ማስታወሻ አለ',
    other: 'ውስጡ በማህደር {count} ማስታወሻዎች አሉ',
  },
