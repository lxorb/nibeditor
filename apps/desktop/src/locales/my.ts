...
export const my: Dictionary = {
  ...
  'That could not be archived.': 'မှတ်တမ်းသိမ်းလို့ မရပါ။',
  ...
  // Archive
  Archive: 'မှတ်တမ်းသိမ်း',
  Unarchive: 'မှတ်တမ်းမှဖယ်',
  Archived: 'မှတ်တမ်းသိမ်းထားသည်',
  Unarchived: 'မှတ်တမ်းမှဖယ်ခဲ့သည်',
  'Archive note': 'မှတ်စုကိုမှတ်တမ်းသိမ်း',
  'Unarchive note': 'မှတ်စုကိုမှတ်တမ်းမှဖယ်',
  'Show them': 'ပြပါ',
  'archived {when}': '{when} မှတ်တမ်းသိမ်းခဲ့',
  '{count} archived notes inside': 'အတွင်းတွင် မှတ်တမ်းသိမ်းထားသော မှတ်စု {count} ခု',
