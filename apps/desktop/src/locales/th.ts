...
export const th: Dictionary = {
  ...
  'That cover could not be written.': 'บันทึกภาพปกนี้ไม่ได้',
  'Drag to reposition': 'ลากเพื่อจัดตำแหน่ง',
  ...
  'That could not be archived.': 'จัดเก็บไม่ได้',
  ...
  'Archive note': 'เก็บโน้ตถาวร',
  'Unarchive note': 'เลิกเก็บโน้ตถาวร',
  'Show them': 'แสดง',
  'archived {when}': 'เก็บถาวร {when}',
  '{count} archived notes inside': 'มีโน้ตที่เก็บถาวร {count} รายการอยู่ข้างใน',
  ...
  'Go to the mark': 'ไปที่เครื่องหมาย',
