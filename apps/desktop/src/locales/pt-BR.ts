...
export const ptBR: Dictionary = {
  ...
  'Release to add a page': 'Solte para adicionar uma página',
  ...
  'That cover could not be written.': 'Não foi possível salvar essa capa.',
  ...
  'Go to the mark': 'Ir para a chamada',
  ...
  'Properties draws the rows and edits them in place; Source is the YAML as typed.':
    'Propriedades mostra as linhas e as edita ali mesmo; Fonte é o YAML como foi digitado.',
  Source: 'Fonte',
  Hidden: 'Oculto',
  Picture: 'Imagem',
  Comment: 'Comentário',
