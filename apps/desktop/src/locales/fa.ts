...
export const fa: Dictionary = {
  ...
  'Set cover': 'انتخاب جلد',
  'Change cover': 'تغییر جلد',
  'Remove cover': 'حذف جلد',
  'That cover could not be written.': 'این جلد ذخیره نشد.',
  'Drag to reposition': 'برای جابه‌جایی بکشید',
  ...
  'That could not be archived.': 'بایگانی نشد.',
  ...
  'Archive note': 'بایگانی یادداشت',
  'Unarchive note': 'خارج کردن یادداشت از بایگانی',
  'Show them': 'نمایش',
  'archived {when}': '{when} بایگانی شد',
  '{count} archived notes inside': {
    one: '{count} یادداشت بایگانی‌شده در آن',
    other: '{count} یادداشت بایگانی‌شده در آن',
  },
  ...
  'Page notes': 'یادداشت‌های صفحه‌ای',
  'New pages': 'صفحه‌های تازه',
