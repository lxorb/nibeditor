...
export const gsw: Dictionary = {
  ...
  'Set cover': 'Titelbild uswähle',
  'Change cover': 'Titelbild ändere',
  'Remove cover': 'Titelbild wegnäh',
  'That cover could not be written.': 'Das Titelbild hät me nöd chöne speichere.',
  'Drag to reposition': 'Zum Verschiebe zie',
  ...
  'That could not be archived.': 'Das hät sich nöd archiviere laa.',
  ...
  Archived: 'Archiviert',
  Unarchived: 'Us em Archiv gholt',
  'Archive note': 'Notiz archiviere',
  'Unarchive note': 'Notiz us em Archiv hole',
  'Show them': 'Zeige',
  'archived {when}': 'archiviert {when}',
  '{count} archived notes inside': {
    one: '{count} archivierti Notiz drin',
    other: '{count} archivierti Notize drin',
  },
  ...
  'Page notes': 'Siitenotize',
  'New pages': 'Nöii Siite',
