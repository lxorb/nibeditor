...
export const id: Dictionary = {
  ...
  'Set cover': 'Atur sampul',
  'Change cover': 'Ubah sampul',
  'Remove cover': 'Hapus sampul',
  'That cover could not be written.': 'Sampul itu tidak dapat disimpan.',
  'Drag to reposition': 'Tarik untuk mengatur posisi',
  ...
  'That could not be archived.': 'Tidak dapat diarsipkan.',
  ...
  Archived: 'Terarsip',
  Unarchived: 'Dikeluarkan dari arsip',
  'Archive note': 'Arsipkan catatan',
  'Unarchive note': 'Keluarkan catatan dari arsip',
  'Show them': 'Tampilkan',
  'archived {when}': 'diarsipkan {when}',
  '{count} archived notes inside': '{count} catatan terarsip di dalamnya',
  ...
  'Page notes': 'Catatan halaman',
  'New pages': 'Halaman baru',
