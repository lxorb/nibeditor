...
export const fil: Dictionary = {
  ...
  'Set cover': 'Itakda ang pabalat',
  'Change cover': 'Baguhin ang pabalat',
  'Remove cover': 'Alisin ang pabalat',
  'That cover could not be written.': 'Hindi maisulat ang pabalat na iyon.',
  'Drag to reposition': 'I-drag para ilipat',
  ...
  'That could not be archived.': 'Hindi na-archive.',
  ...
  'Archive note': 'I-archive ang tala',
  'Unarchive note': 'Alisin ang tala sa archive',
  'Show them': 'Ipakita',
  'archived {when}': 'in-archive {when}',
  '{count} archived notes inside': {
    one: '{count} naka-archive na tala sa loob',
    other: '{count} naka-archive na tala sa loob',
  },
  ...
  'Page notes': 'Mga talang may pahina',
  'New pages': 'Mga bagong pahina',
  ...
  'Go to the mark': 'Pumunta sa marka',
