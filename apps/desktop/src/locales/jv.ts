...
export const jv: Dictionary = {
  ...
  'That could not be archived.': 'Ora bisa diarsipake.',
  ...
  // Archive
  Archive: 'Arsipake',
  Unarchive: 'Jupuk saka arsip',
  Archived: 'Diarsipake',
  Unarchived: 'Dijupuk saka arsip',
  'Archive note': 'Arsipake cathetan',
  'Unarchive note': 'Jupuk cathetan saka arsip',
  'Show them': 'Tuduhake',
  'archived {when}': 'diarsipake {when}',
  '{count} archived notes inside': '{count} cathetan arsip ing njero',
